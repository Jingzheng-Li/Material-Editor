...
//#define ImFloorStd(X_new)     floorf(X_new)           // We use our own, see ImFloor() and ImFloorSigned()
...
// perpendicular to X_new axis. Follow steps in the article from this starting condition and you will
...
// X_new/Y enums are fixed to 0/1 so they may be used to index ImVec2
enum ImGuiAxis
{
    ImGuiAxis_None = -1,
    ImGuiAxis_X = 0,
