...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        if (ImGui::BeginPopup("mypicker"))
        {
            ...
            ImGui::BeginGroup(); // Lock X_new position
            ImGui::Text("Current");
...
static void ShowDemoWindowTables()
{
    ...
    {
        // First example: showcase use of padding flags and effect of BorderOuterV/BorderInnerV on X_new padding.
        // We don't expose BorderOuterH/BorderInnerH here because they have no effect on X_new padding.
        HelpMarker(
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    // - Tab is selected when clicking the X_new close button.
    // - Closure is not assumed (will wait for user to stop submitting the tab).
    //   Otherwise closure is assumed when pressing the X_new, so if you keep submitting the tab may reappear at end of tab bar.
